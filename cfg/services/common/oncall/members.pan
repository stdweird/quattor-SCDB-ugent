...
"contents/raw_google/login" = "hpc-admin@lists.ugent.be";
"contents/raw_google/passwd" = GOOGLE_CALENDAR_PASSWD;
"contents/raw_google/url" = GOOGLE_CALENDAR_URL;
...
"contents/admins/shortn" = "kh,wdp,sdw,jt,ag,kw";
...
"contents/kw/name" = "Kenneth Waegeman";
"contents/kw/email" = "kenneth.waegeman@ugent.be";
"contents/kw/tel" = KENNETH_W_PHONE;

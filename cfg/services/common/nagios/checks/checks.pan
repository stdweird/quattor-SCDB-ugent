...
'/software/components/nrpe/options/command' ?= dict();
...
# check ceph health and daemons
include CHECKS_INCL+"ceph_health";
include CHECKS_INCL+"ceph_health_fsload";
include CHECKS_INCL+"ceph_osd";
include CHECKS_INCL+"ceph_mon";
...
include CHECKS_INCL+"onehosts";

# check opennebula datastore
include CHECKS_INCL+"onedatastore";

# check opennebula VMs
include CHECKS_INCL+"onevms";

# check KVM virsh
include CHECKS_INCL+"virsh";
...
# check the number of connections to moab
include CHECKS_INCL+"moab_connections";
...
'/software/components/nrpe/options/command' = {
    ...
    SELF["check_rpm_repo"] = CHECKS_LOCATION+"check_rpm_repo.py --nagios-report";

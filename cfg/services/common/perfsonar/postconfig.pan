...
unique template common/perfsonar/postconfig;


variable PERFSONAR_POSTCONFIG_SCRIPT = '/var/quattor/script/perfsonar-postconfig';

include {error('Do not use this template in its current form.')};
...
'/software/components/filecopy/services' = {
  SELF[escape(PERFSONAR_POSTCONFIG_SCRIPT) ] = dict("config", CONTENTS,
                                                     "perms", "0755",
                                                     "owner", "root",

...
'/software/components/nrpe/options/command' = npush(CHECK_NAME,"sudo " + CHECKS_LOCATION+"restricted/"+CHECK_NAME + " -B " + HW_BIOS_VERSION  + " -r " +  HW_BIOS_RELEASE_DATE + " -i " + HW_DIMM_AMOUNT + " -s " +  HW_DIMM_SIZE  + " -c " +  HW_CPU_CORES_PER_SOCKET  + " -S " + HW_CPU_SOCKETS  );
